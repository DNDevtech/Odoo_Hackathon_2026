...
class TransitOpsDashboard(http.Controller):
    ...
    @http.route('/transit/dashboard', type='http', auth='user', website=False)
    def dashboard(self, **kw):
        ...
        dist = [
            ...
            {'label': 'Retired', 'count': retired, 'color': '#eb5757'},
        ]
        ...
        return request.render('transitops.dashboard_template', values)
